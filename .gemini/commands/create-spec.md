---
description: Create a spec file and feature branch for the next Sarathi Wallet step
...
Sarathi Wallet expense tracker. Always follow the rules in CLAUDE.md or GEMINI.md.
...
it exists at this stage of the Sarathi Wallet roadmap.
