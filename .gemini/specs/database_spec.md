...
This step establishes the **data layer foundation** for the Sarathi Wallet application.
...
- Opens connection to `SarathiWallet.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
  - name: Demo User
  - email: [demo@SarathiWallet.com](mailto:demo@SarathiWallet.com)
